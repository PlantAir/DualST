...
from models.layer.gse_kan import GlobalSemanticEncoder
from models.layer.stnorm_kan import STnorm
from models.layer.conv_kan import LayerNorm,Block
...
class DualST(nn.Module):
    ...
    def __init__(self,dconf):
        ...
        self.ext_c = nn.Sequential(
            ...
            nn.GELU(),
            MoKLayer(self.mconf.ext_cp_channel,
